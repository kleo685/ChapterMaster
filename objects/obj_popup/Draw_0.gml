        ...
        if (top!=0){
            ...
            if (target_comp=1) and (is_struct(weapon_one_data)){// Check numbers
                ...
                if (is_struct(armour_data)){
                    ...
                    if ((array_contains(armour_data.tags, "terminator"))) and (!array_contains(weapon_one_data.tags, "terminator")) {
                        n_good1 = 0;
                        warning = "This weapon cannot be used with Terminator armour.";
                    }
                }
            }
             if (target_comp=2) and (is_struct(weapon_two_data)){// Check numbers
                ...
                if (is_struct(armour_data)){
                    ...
                    if ((array_contains(armour_data.tags, "terminator"))) and (!array_contains(weapon_two_data.tags, "terminator")) {
                        n_good2 = 0;
                        warning = "This weapon cannot be used with Terminator armour.";
                    }
