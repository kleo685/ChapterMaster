                ...
                repeat(3600) {
                    if (co < 11) {
                        ...
                        if (stop = 0) {
                            ...
                            } // show_message(string(co)+":"+string(v)+" is fighting");
                            ...
                            if (attack = 1) and(ship_all[500] = 1) {
                                ...
                                if (v <= 100) {
                                    if (obj_ini.veh_loc[co][v] = p_target.name) and(obj_ini.veh_wid[co][v] = planet_number) then obj_ncombat.veh_fighting[co][v] = 1;
                                }
                            }
                        }
                    }
