...
if (shop = "equipment") {
    ...
    item[i] = "Combiplasma";
    item_stocked[i] = scr_item_count(item[i]);
    if (research.bolt[0]<1 || research.plasma[0] < 1) then noforge[i] = true;
    item_cost[i] = 110;
    if (rene = 1) {
        nobuy[i] = 1;
        item_cost[i] = 0;
    ...
    item[i] = "Combimelta";
    item_stocked[i] = scr_item_count(item[i]);
    if (research.bolt[0]<1 || research.melta[0]<1) then noforge[i] = true
    item_cost[i] = 40;
    if (rene = 1) {
        nobuy[i] = 1;
        item_cost[i] = 0;
    ...
    item[i] = "Combigrav";
    item_stocked[i] = scr_item_count(item[i]);
    if (research.bolt[0]<1 || research.grav[0]<1) then noforge[i] = true
    item_cost[i] = 110;
    if (rene == 1) {
        nobuy[i] = 1;
        item_cost[i] = 0;
    ...
    i += 1;
    item[i] = "Hand Flamer";
    if (research.flame[0]<1) then noforge[i] = true
    item_stocked[i] = scr_item_count(item[i]);
    item_cost[i] = 12;
    ...
    i += 1;
    item[i] = "Grav-Pistol";
     if (research.grav[0]<1) then noforge[i] = true
    item_stocked[i] = scr_item_count(item[i]);
    item_cost[i] = 60;
    if (rene = 1) {
        nobuy[i] = 1;
