...
//     if (scr_hit(xx,yy,xx+_spr_width,yy+_spr_height)=true) and (fading=0) {
//         hover[1]=1;
//     } else {
//         hover[1]=0;
//     }
...
// if (!instance_exists(obj_popup)) and (!instance_exists(obj_credits)) and (!instance_exists(obj_saveload)) and (fading=0){
    // xx=126;if (mouse_x>=xx) and (mouse_y>yy) and (mouse_x<xx+265) and (mouse_y<yy+48) {
    //     hover[1]=1;
    // } else {
    //     hover[1]=0;
    // }
    // xx=126;if (mouse_x>=xx) and (mouse_y>yy+44) and (mouse_x<xx+265) and (mouse_y<yy+92) {
    //     hover[2]=1;
    // } else {
    //     hover[2]=0;
    // }
    // xx=126;if (mouse_x>=xx) and (mouse_y>yy+88) and (mouse_x<xx+265) and (mouse_y<yy+136){
    //     hover[3]=1;
    // } else {
    //     hover[3]=0;
    // }
    // xx=126;if (mouse_x>=xx) and (mouse_y>yy+132) and (mouse_x<xx+265) and (mouse_y<yy+180){
    //     hover[4]=1;
    // } else {
    //     hover[4]=0;
    // }
