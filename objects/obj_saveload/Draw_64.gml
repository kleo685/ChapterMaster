...
if __b__ {
    ...
    /*if (save_part+load_part>0){
        ...
        draw_sprite(spr_saveload,0,0,345);
        
        draw_set_color(50688);draw_rectangle(74,147,566,202,0);
        draw_set_color(c_gray);draw_rectangle(min(74+((bar/100)*492),566),147,566,202,0);
        draw_set_color(38144);draw_rectangle(74,147,566,202,1);
        
        draw_set_halign(fa_center);draw_set_font(fnt_large);
        if (save_part>0) then draw_text_transformed(320,94,"Saving",2,1.5,0);
        if (load_part>0) and (global.restart=0) then draw_text_transformed(320,94,"Loading",2,1.5,0);
        if (load_part>0) and (global.restart>0) then draw_text_transformed(320,94,"Restarting",2,1.5,0);
        
        draw_set_font(fnt_menu);
        draw_text(320,209,string(txt));
    }*/
    ...
    if (save_part + load_part > 0) {
        ...
        // 
        // draw_sprite(spr_load_splash,splash,0,0);
        ...
        if (save_part > 0) then draw_sprite(spr_load_text, 1, 1068, 821);
        if (load_part > 0) and(global.restart = 0) then draw_sprite(spr_load_text, 0, 1068, 821);
        if (load_part > 0) and(global.restart > 0) then draw_sprite(spr_load_text, 2, 1068, 821);
    ...
    if (menu = 1) or(menu = 2) { // This is the other one
        ...
        // draw_text(40,730,"Menu: "+string(menu)+", First Open: "+string(first_open)+", Top Save: "+string(top));
        // draw_text(40,730,string(debug));
        draw_set_halign(fa_center);

        draw_set_color(0);

        draw_sprite(spr_save_header, 0, 0, 27);
        if (menu = 1) then draw_sprite(spr_save_headers, 1, 800, 60);
    ...
    draw_set_alpha(1);draw_text(30,30,"First Open: "+string(first_open));
    draw_set_alpha(1);draw_text(30,50,"save1: "+string(save[1]));
    draw_set_alpha(1);draw_text(30,70,"save2: "+string(save[2]));
    draw_set_alpha(1);draw_text(30,90,"save3: "+string(save[3]));
    draw_set_alpha(1);draw_text(30,110,"save4: "+string(save[4]));
    draw_set_alpha(1);draw_text(30,130,"save5: "+string(save[5]));
    draw_set_alpha(1);draw_text(30,150,"save6: "+string(save[6]));
    draw_set_alpha(1);draw_text(30,170,"save7: "+string(save[7]));
    draw_set_alpha(1);draw_text(30,190,"save8: "+string(save[8]));
    draw_set_alpha(1);draw_text(30,210,"save9: "+string(save[9]));
    draw_set_alpha(1);draw_text(30,230,"save10: "+string(save[10]));
    draw_set_alpha(1);draw_text(30,250,"save11: "+string(save[11]));
    draw_set_alpha(1);draw_text(30,270,"save12: "+string(save[12]));*/
