            ...
            if (instance_exists(thata)){
                ...
                if (good>0){
                    repeat(10){
                        ...
                        thata.marine_wep1[ii]="Power Weapon";thata.marine_wep2[ii]="Plasma Gun";
                        thata.marine_armour[ii]="Dragon Scales";thata.marine_gear[ii]="Servo-arm";
                    ...
                    repeat(20){
                        ...
                        thata.marine_armour[ii]="Skitarii Armour";thata.marine_gear[ii]="";
                        thata.ally[ii]=true;thata.marine_dead[ii]=0;ii+=1;thata.men+=1;
                    }
                }
