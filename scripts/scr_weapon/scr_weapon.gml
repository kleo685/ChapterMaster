global.weapons = {
	...
	"Combiflamer": {
		...
		"description": "A standard Bolter with an underslung flamer for expanded tactical utility.",
		"weight": 25,
		"ammo": 15,
		"range": 10,
		"spli": 3,
		"arp": 0,
		"second_profiles": ["Underslung Flamer"],
		"tags": ["combi", "bolt", "assault"]
	},
	"Incinerator": {
		"attack": {
			"standard": 500,
    ...
    static item_tooltip_desc_gen = function(){
        ...
        for (var i = 0; i < array_length(stat_order); i++) {
            ...
            switch (stat) {
                ...
                case "max_weight":
                    if (max_weight != 0) {
                        item_desc_tooltip += $"Max Weight: {format_number_with_sign(max_weight)}#"
                    }
                    break;
