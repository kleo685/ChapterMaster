function scr_chapter_new(argument0) {
	...
	repeat(3){i+=1;// First is for the correct slot, second is for default
		...
		role[i,11]="Ancient";wep1[i,11]="Company Standard";wep2[i,11]="Power Sword";armour[i,11]="Power Armour";
	    ...
	    role[i,16]="Techmarine";wep1[i,16]="Power Axe";wep2[i,16]="Bolt Pistol";armour[i,16]="Artificer Armour";gear[i,16]="Servo-arm";
